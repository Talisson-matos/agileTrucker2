            ...
            <div className="modal-content">
              {!guiaSubmitted ? (
                <>
                  ...
                  >
                    <option value="">SELECIONAR UF CRED. PRESUMIDO - (REMETENTE)</option>
                    <option value="CREDITO PRESUMIDO REF. EMBASAMENTO LEGAL ART. 107 INCISO 37 CONVÊNIO 106/96">MG - MINAS GERAIS</option>
                    <option value="CREDITO PRESUMIDO CONF. CONVÊNIO ICMS 106/96 COMBINADO AO § 3º PELO CONV. ICMS 85/03">PA - PARÁ</option>
                    <option value="ANEXO I AO DECRETO Nº 18.955, DE 22 DE DEZEMBRO DE 1997 - CADERNO III">DF - DISTRITO FEDEDERAL</option>
                    <option value="BASE DE CALCULO DO ICMS REDUZIDA, CONFORME ART. 87, INCISO XX-B, DO RICMS.">RN - RIO GRANDE DO NORTE</option>
                    <option value="CONVÊNIO ICMS 85/2003 ART. 3.2 DO REGULAMENTO DO PARANÁ">PR - PARANÁ</option>
                    <option value="CREDITO PRESUMIDO CONF. CONVÊNIO ICMS 106/96 COMBINADO AO INCISO IV, DO ART. 57 DO RICMS-SE">SE - SERGIPE</option>
                    <option value="CREDITO PRESUMIDO CONF. CONVÊNIO ICMS 106/96 COMBINADO AO INCISO IX, DO ART. 1 DO ANEXO 1.5 DO ANEXO 1.0 DO RICMS-MA">MA - MARANHÃO</option>
                    <option value="CREDITO PRESUMIDO CONF. CONVÊNIO ICMS 106/96 COMBINADO AO DECRETO Nº 24.333/97, E NO INCISO V DO ART. 64 DO DECRETO Nº 24.569, DE 31 DE JULHO DE 1997.">CE - CEARÁ</option>
                    <option value="CREDITO PRESUMIDO CONF. CONVÊNIO ICMS 106/96 COMBINADO A ALINEA 'B' DO INCISO III DO ART. 270 DO RICMS/BA">BA - BAHIA</option>
                    <option value="CREDITO PRESUMIDO CONF. DECRETO Nº 27815 DE 24/01/2001 COMBINADO AO CONVÊNIO ICMS 106/96.">RJ - RIO DE JANEIRO</option>
                    <option value="CREDITO PRESUMIDO - TRANSPORTADORA NÃO OBRIGADO A INSCRIÇÃO DENTRO DO ESTADO DO PE CONF. ALÍNEA 'E' DO INC XI DO ART. 35 DO DECRETO 14876/91.">PE - PERNAMBUCO</option>
                    <option value="CREDITO PRESUMIDO - PRESTADOR DE SERVIÇO DE TRANSPORTE NÃO OBRIGADO À INSCRIÇÃO NO CCICMS - CONF. § 3º, ART. 25 DO ANEXO II DO RICMS/SC">SC - SANTA CATARINA</option>
                    <option value="CREDITO PRESUMIDO - PRESTADOR NÃO OBRIGADO À INSCRIÇÃO NESTA UF. ALINEA C, INC. III, ART. 56 DO RICMS/PI">PI - PIAUÍ</option>
                    <option value="CREDITO PRESUMIDO - INCISO II, § 1º, DO ARTIGO 64 DO RCTE-GO">GO - GOIÁS</option>
